...
ob_start(static fn(string $html):string=>str_replace(
    ['</head>','<body>','<div class="stage"><div class="event">','</div><div class="meta">'],
    [
        '<link rel="stylesheet" href="../public/css/projector-themes-v352.css?v=355"><link rel="stylesheet" href="../public/css/projector-roster-v615.css?v=615"><link rel="stylesheet" href="../public/css/projector-safe-v616.css?v=621"></head>',
        '<body data-projector-theme="'.e($projectorTheme).'" data-custom-background="'.($hasCustomHolding?'1':'0').'">',
        '<div class="stage"><div class="projection-official">BDC · Official Live Display</div><div class="projection-heading-row"><div class="projection-brand"><img src="'.e(url('public/assets/bdc-logo.png')).'" alt="Bachata Dance Council"></div><div class="event">',
