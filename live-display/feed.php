...
if ($type === "matching") {
    ...
    $jq=$pdo->prepare("SELECT id,judge_order,judge_name,is_chief FROM {$judgeTable} WHERE round_id=:r ORDER BY judge_order,id");
