...
$pdo->prepare("UPDATE bdc_live_display_sessions SET screen_type=:t,reveal_place=NULL,page_number=1,state_version=state_version+1,updated_at=NOW() WHERE id=:id AND loop_enabled=1")->execute(['t'=>$next,'id'=>$s['id']]);
