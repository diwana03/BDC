...
Connect ChatGPT to `https://bachatadancecouncil.com/portal/mcp/`. Sign in to the BDC Portal as Super Admin before starting authorization. After staging additions, review them under Administration > Integration Review > Events.
