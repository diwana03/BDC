...
<div class="container-fluid py-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        ...
        <?php if (Auth::can('competitors.edit')): ?>
            <div class="d-flex flex-wrap gap-2"><a class="btn btn-outline-warning" href="special-category-recovery.php">Special Category Recovery</a><a class="btn btn-outline-info" href="unapproved-profile-repair.php">Unapproved Profile Repair</a><a class="btn btn-outline-danger" href="merge.php">Merge duplicates</a> <a class="btn btn-outline-primary" href="career-links.php">Move Results & Career Links</a><a class="btn btn-dark" href="edit.php">Add competitor</a></div>
        <?php endif; ?>
    </div>
