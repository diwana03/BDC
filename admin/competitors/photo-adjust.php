...
if($_SERVER['REQUEST_METHOD']==='POST'){
 try{
  ...
  }elseif(in_array($action,['remove_background','apply_background_removal','discard_background_preview'],true)){
   if(!Auth::isSuperAdmin())throw new RuntimeException('Only the Super Admin can remove photo backgrounds.');
...
document.getElementById('resetView').addEventListener('click',()=>{zoom.value='1';x=0;y=0;draw()});
