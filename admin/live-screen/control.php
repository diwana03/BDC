...
?><?= e($l)
?></button><?php
endforeach; ?></div><div class="border rounded p-3 mb-3"><div class="fw-bold">Presentation Effects</div><div class="small text-muted mb-2">Trigger an animation on the connected projector without changing the selected scoring screen.</div><div class="d-flex flex-wrap gap-2"><button type="button" class="effect btn btn-outline-dark" data-effect="drumroll">🥁 Drum Roll</button><button type="button" class="effect btn btn-outline-primary" data-effect="fireworks">🎆 Fireworks</button><button type="button" class="effect btn btn-outline-warning" data-effect="confetti">🎉 Confetti</button><button type="button" class="effect btn btn-outline-secondary" data-effect="none">Clear Effect</button></div></div><?php if (
