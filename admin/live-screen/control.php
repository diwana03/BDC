...
ob_start(static fn(string $html):string=>str_replace('</head>','<script defer src="../../public/assets/js/bdc-theme.js?v=505"></script><script defer src="projector-control-v350.js?v=350"></script></head>',$html));
use App\Core\Auth;
use App\Core\Csrf;
