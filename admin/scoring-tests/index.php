...
<?php if($round):?><div class="card shadow-sm mb-4 border-info-subtle"><div class="card-body d-flex justify-content-between align-items-center gap-3 flex-wrap"><div><h2 class="h5 mb-1">Test Flights <span class="badge text-bg-secondary">Optional</span></h2><div class="small text-muted">Exercise the same unlimited, bib-ordered Flight workflow used by Live scoring—including Final couples.</div></div><a class="btn btn-outline-primary" href="../scoring/flights.php?round_id=<?=$roundId?>&amp;data_mode=test">Manage Test Flights</a></div></div><?php endif;?>
...
<div class="card shadow-sm mb-4"><div class="card-body">
 ...
 <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
  ...
  </form><a class="btn btn-outline-danger" target="_blank" rel="noopener" href="../live-screen/control.php?round_id=<?=$roundId?>&amp;data_mode=test#emcee-match">Test Event Projection &amp; Emcee Match</a>
 </div>
