Warning: truncated output (original token count: 34987)
Total output lines: 2167
...
try{
 if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  if($action==='generate_test_event'){
   ...
   $nextStmt=$pd…4987 tokens truncated…id']]??null;$rb=$results[$b['id']]??null;
...
<div class="card shadow-sm mb-4 border-danger">
 <div class="card-header bg-danger-subtle d-flex justify-content-between align-items-center">
  ...
  <span class="badge text-bg-danger">TEST ONLY</span>
 </div>
 <div class="card-body">
  <?php if(!$round):?>
   ...
   <div class="row g-3">
    <div class="col-xl-4">
     <form method="post" class="border rounded p-3 h-100">
      ...
      <button class="btn btn-outline-danger w-100 mt-3">Generate Competitors</button>
     </form>
    </div>
    <div class="col-xl-4">
     <form method="post" class="border rounded p-3 h-100">
      ...
      <button class="btn btn-outline-danger w-100 mt-3">Generate Judges</button>
     </form>
    </div>
    <div class="col-xl-4">
