...
<div class="col-lg-4"><section class="card mode-card border-danger"><div class="card-body p-4 d-flex flex-column"><div class="mode-icon mb-4">▣</div><h2 class="h3">Live Screen Projector</h2><p class="text-muted flex-grow-1">Test the projector workflow using isolated Testing data.</p><a class="btn btn-danger btn-lg" target="_blank" rel="noopener" href="../live-screen/test-index.php">Open Test Projector</a></div></section></div><div class="col-lg-4"><section class="card mode-card border-warning"><div class="card-body p-4 d-flex flex-column"><div class="mode-icon mb-4">★</div><h2 class="h3">Dance Cup Scoring</h2><p class="text-muted flex-grow-1">Test numeric criteria scoring with isolated Test events and Dance Cup records.</p><a class="btn btn-warning btn-lg" href="../dance-cup/?data_mode=test">Continue</a></div></section></div></div></main></body></html>
