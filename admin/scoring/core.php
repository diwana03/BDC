Warning: truncated output (original token count: 38934)
  ...
  if($action==='create_round'){
   ...
   try{
    ...
    if((int)$remainingTie->fetchColumn()===0 && ($roundForTie['scoring_mode']??'manual')==='automated'){
     $pdo->prepare("UPDATE bdc_scoring_round…8934 tokens truncated…$finalPairs,function($a,$b)use($finalResults){
