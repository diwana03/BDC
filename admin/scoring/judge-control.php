...
if($_SERVER['REQUEST_METHOD']==='POST'){
    try{
        ...
        if($action==='regenerate'){
            ...
            if($token==='')throw new RuntimeException('Regenerate this judge link before sending it.');
