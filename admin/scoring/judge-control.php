...
try{
    ...
    foreach($judges as &$judge){
        ...
        if($judge['url']!==''){
            ...
            $judge['email']='mailto:?subject='.rawurlencode('IMPORTANT — BDC Judge Scoring Link — '.$round['event_name']).'&body='.rawurlencode("IMPORTANT: Secure judging access\n\n".$shareText);
        }else{
