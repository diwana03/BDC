...
if($roundId>0){
 ...
 $html=str_replace(['Bachata_rising','Bachata_open','Bachata_invitational','BACHATA_RISING','BACHATA_OPEN','BACHATA_INVITATIONAL','href="?mode=manual"','publish.php?round_id=','registration-desk/?token=','<datalist id="finalCompetitorSuggestions"></datalist>'],['Bachata Rising','Bachata Open','Bachata Invitational','BACHATA RISING','BACHATA OPEN','BACHATA INVITATIONAL','href="?mode=special"','special-publish.php?round_id=','registration-desk/special.php?token=','<datalist id="finalCompetitorSuggestions">'.$options.'</datalist>'],$html);
