...
for(const required of ['One permanent WDC identity','bdc_wdc_identities','bdc_wdc_registrations','registration_count','Adjust photo','missing_photo'])assert(page.includes(required),'missing recovered WDC feature: '+required);
