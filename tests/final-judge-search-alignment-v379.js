...
for(const path of ['admin/scoring-tests/index.php','admin/scoring/core.php'])assert(/scoring-judge-directory\.js\?v=(?:37[9]|38\d|[4-9]\d{2,})/.test(fs.readFileSync(path,'utf8')),path+' must load aligned search asset');
