...
assert(photo.includes('SELECT id,identity_code,display_name,entry_type,solo_competitor_id,photo_url,original_photo_url FROM bdc_wdc_identities'),'WDC photo page must use the minimal identity and restore-source read');
