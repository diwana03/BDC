...
for (const marker of [
  "roster.href='../public/css/projector-roster-v615.css?v=636'",
...
assert(!css.includes('.stage .competitor-identity'), 'removed DOM-only competitor layout must stay removed');
