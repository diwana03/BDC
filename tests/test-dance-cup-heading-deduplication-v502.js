...
assert(display.includes("const category=(latest?.state?.category_name||'Dance Cup Category')+' · '+label(latest?.state?.round_name||'')"), 'presentation area must build one complete category and round line');
