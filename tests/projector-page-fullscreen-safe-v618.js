...
assert(feed.includes('projector-safe-v616.css?v=619'), 'fresh safe-area cache key missing');
...
assert.strictEqual(version.version, '2.3.3-dev619');
assert.strictEqual(version.build, 3325);
