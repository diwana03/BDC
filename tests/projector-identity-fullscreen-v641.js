...
requireText(feed, 'projector-roster-v615.css?v=<?=', 'dynamic roster stylesheet');
requireText(feed, 'id="bdc-projector-roster-fix"', 'single active roster stylesheet id');
requireText(audience, "roster.href='../public/css/projector-roster-v615.css?v=649'", 'outer-shell roster parity');
