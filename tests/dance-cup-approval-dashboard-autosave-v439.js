...
assert(view.includes('Review, Approve or Reject')&&view.includes('Super Admin must then approve'),'Automatic workspace must show the two-stage workflow');
...
for(const marker of ['requireSuperAdmin','Pending Dance Cup Result Approval','Review, Approve or Reject','approval-review.php'])assert(approvals.includes(marker),'Manual and Automatic approval queue missing '+marker);
