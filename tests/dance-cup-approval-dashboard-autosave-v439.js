...
for(const marker of ['Dance Cup Competitor','WDC identities','Active registrations','dance_style','entry_type','competition_level'])assert(participants.includes(marker),'Dance Cup competitor dashboard missing '+marker);
