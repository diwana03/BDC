...
assert(judge.includes("REQUEST_METHOD']==='POST'&&(string)(\$_POST['action']??'')!=='resolve_wdc_tie'&&!$criteriaAccepted"),'Server must reject scoring before acceptance while preserving the Chief Judge tie workflow');
