...
foreach(['drive.file','access_type','offline','refresh_token','google-drive-oauth-token.json','ensureManagedFolder','Connect Google Drive','disconnect_drive','bdc_google_oauth_state','initCodeClient','ux_mode','popup','popupRedirectUri','payload'] as $marker){if(!str_contains($all,$marker)){fwrite(STDERR,"Missing {$marker}\n");exit(1);}}
