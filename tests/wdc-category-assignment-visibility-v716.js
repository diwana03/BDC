...
assert(Number(version.version.match(/^2\.3\.6-dev(\d+)$/)?.[1]||0)>=716,'release must retain dev716 or newer');
assert(version.build>=3422,'release build must retain 3422 or newer');
