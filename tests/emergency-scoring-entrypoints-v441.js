...
for(const marker of ['information_schema.TABLES','$requestsReady','Dance Participation','Some Dance Cup dashboard data could not be loaded:'])assert(participants.includes(marker),'Participant fallback missing '+marker);
...
assert(participants.includes('Dance Cup participation data is not available yet.')&&participants.includes('Some Dance Cup dashboard data could not be loaded:'),'Participants migration fallback must render a normal recovery page');
