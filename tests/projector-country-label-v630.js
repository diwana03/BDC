...
assert(css.includes('.stage .judge-country-entry:only-child'), 'Global single-country judge layout override is missing.');
...
assert.match(feed, /projector-roster-v615\.css\?v=<\?=/, 'Projector stylesheet must use a dynamic cache key.');
