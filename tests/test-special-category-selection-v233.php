...
$categoryService=file_get_contents(__DIR__.'/../app/Services/SpecialCategoryService.php');
...
$labelSurfaces=[
 ...
 'admin/competitors/edit.php','admin/competitors/index.php','admin/scoring/special.php',
];
foreach($labelSurfaces as $path){
