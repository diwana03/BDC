...
$checks = [
    ...
    'sound cache refreshed' => str_contains($display, 'effect-sound.js?v=300'),
    'sound receives explicit effect event' => str_contains($display, 'bdc-projector-effect') && str_contains($sound, "addEventListener('bdc-projector-effect'"),
