...
assert(display.includes('.rank-photo{width:clamp(46px,4.4vw,83px);height:clamp(58px,5.5vw,104px)'), 'scoreboard contestant photos must retain a large 4:5 preview');
