...
assert(display.includes('padding-top:clamp(12px,2.4vh,34px)'), 'shared projection stage must sit slightly lower');
assert(display.includes('font-size:clamp(17px,1.55vw,30px);font-weight:800'), 'category heading must be larger and stronger');
...
assert(launch.includes("'&presentation=502'"), 'projector launch must invalidate the previous presentation document');
