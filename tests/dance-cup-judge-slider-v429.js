...
assert(judge.includes('dance-cup-judge-live.js?v=457')&&judge.includes('scoring-premium.css?v=486'),'judge slider assets must load their current cache-busted versions');
