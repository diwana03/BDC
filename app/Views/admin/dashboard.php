...
) ?>"><link rel="stylesheet" data-bdc-theme-styles href="<?= e(url("public/assets/css/bdc-theme.css?v=505")) ?>"><link rel="stylesheet" href="<?= e(url("public/assets/css/admin-mobile-v428.css?v=428")) ?>"><script defer src="<?= e(url("public/assets/js/bdc-theme.js?v=505")) ?>"></script><script defer src="<?= e(url("public/assets/js/admin-mobile-v428.js?v=428")) ?>"></script></head><body class="admin-v203 <?= e(
    $bdcEnvironmentClass,
