...
<details class="admin-nav-group-v203" open><summary>Dance Cup</summary><div class="admin-nav-group-links-v203">
    ...
    <?php if(\App\Core\Auth::isSuperAdmin())$sidebarLink('admin/dance-cup/competitors-premium.php', '✦', 'WDC Premium Preview', 'TEST'); ?>
...
<details class="admin-nav-group-v203"><summary>People</summary><div class="admin-nav-group-links-v203">
    ...
    <?php $sidebarLink('admin/integration-review/', '⇧', 'Integration Review', 'NEW', (int)($stats['integration_updates'] ?? 0)); ?>
