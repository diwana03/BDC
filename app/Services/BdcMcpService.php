...
final class BdcMcpService
{
    ...
    {
        return match($name){'list_event_rounds'=>self::rounds($pdo,$a),'list_division_competitors'=>self::competitors($pdo,$a),'stage_competitor_additions'=>self::stage($pdo,$a),'get_staged_batch_status'=>self::status($pdo,$a),'diagnose_projection'=>ProjectionDiagnosticsService::diagnose($pdo,$a),default=>throw new RuntimeException('Unknown tool.')};
    }
