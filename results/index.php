...
if($segment==='repository'){
 ...
 if($query!==''&&$rows){
  ...
  $summarySql="SELECT c.id,c.exact_name,c.bdc_id,c.photo_url,
               ...
               GROUP BY c.id,c.exact_name,c.bdc_id,c.photo_url
